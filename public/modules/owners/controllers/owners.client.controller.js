    ...
    //            console.log(owner);
        ...
        ******/
		...
		$scope.update = function() {
            ...
            var picks = $scope.owner.draftPicks;
            var pickArray=[];
            pickArray=picks.split(',');
            var req={};
            req.ownerId=$scope.owner._id;
            req.additionalCap=$scope.owner.additionalCap;            
            req.draftPicks=pickArray;
            console.log(req);
            $http.put('/ownerUpdate',req).
                success(function(data, status){
                    console.log(data);
                });
            window.location.href='#!/allowners';
            return;
		};
